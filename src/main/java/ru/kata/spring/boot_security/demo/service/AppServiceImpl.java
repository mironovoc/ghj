...
import ru.kata.spring.boot_security.demo.config.exception.UserDataIntegrityViolationException;
import ru.kata.spring.boot_security.demo.config.exception.UserNotFoundException;
import ru.kata.spring.boot_security.demo.config.exception.UserValidationException;
